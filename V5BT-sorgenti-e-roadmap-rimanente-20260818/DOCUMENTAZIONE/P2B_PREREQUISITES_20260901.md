...
I test locali relativi ad audit, retention, foundation e runner sono 21/21.
Sul Raspberry il preflight ha confermato zero righe; dopo backup con restore di
prova e clone a servizio fermo, la 006 e stata applicata e verificata due volte.
Il DEV ora ha 16 partizioni incluse la default, registro ID globale vuoto,
RET-01 ancora disabilitata e health Cassa 200/200. Evidenza:
`reports/postgresql-migration/mig026/raspberry-dev-sd-partitioned-20260901.json`.
