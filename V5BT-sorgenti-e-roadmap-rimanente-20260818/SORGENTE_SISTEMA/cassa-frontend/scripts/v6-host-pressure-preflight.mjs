...
export const V6_HOST_PRESSURE_THRESHOLDS_BYTES = Object.freeze({
  micro: Object.freeze({
...
export const V6_HOST_PRESSURE_MAX_LOAD_PER_CPU = 0.75;
...
export function evaluateV6HostPressure({
  platform,
  mode,
  dryRun = false,
  ...
  const thresholds = V6_HOST_PRESSURE_THRESHOLDS_BYTES[mode];
  ...
  const checks = {
    ...
    schedulerLoad: {
      ...
      maximumLoadAverage1mPerCpu: V6_HOST_PRESSURE_MAX_LOAD_PER_CPU,
      ok:
        loadAverage1mPerCpu !== null
          ? loadAverage1mPerCpu <= V6_HOST_PRESSURE_MAX_LOAD_PER_CPU
          : false,
    },
  };
