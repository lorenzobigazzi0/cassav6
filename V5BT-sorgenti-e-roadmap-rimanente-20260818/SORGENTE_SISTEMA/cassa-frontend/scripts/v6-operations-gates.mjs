export const V6_MAX_IN_FLIGHT_PER_DEVICE = 2;
export const V6_MAX_IN_FLIGHT_GLOBAL = 60;
export const V6_ACTION_P95_MAX_MS = 3_000;
export const V6_COMMAND_P95_MAX_MS = 8_000;
export const V6_ACTION_MAX_MS = 30_000;
export const V6_GUI_HOT_READ_BASE_BUDGET = 10;
export const V6_GUI_HOT_READS_PER_ACTION_BUDGET = 2;
export const V6_BATTERY_NOTIFICATION_INTERVAL_MS = 120_000;
...
export function summarizeV6GuiRequestTraffic(
  guiDiagnostics,
  actionsPerDevice,
  {
    baseBudget = V6_GUI_HOT_READ_BASE_BUDGET,
    readsPerActionBudget = V6_GUI_HOT_READS_PER_ACTION_BUDGET,
  } = {},
) {
...
export function evaluateV6OperationsRuntimeGate({
  profile,
  commandLatencyMs,
  guiDiagnostics,
  actionsPerDevice,
  ...
  guiBaseBudget = V6_GUI_HOT_READ_BASE_BUDGET,
  guiReadsPerActionBudget = V6_GUI_HOT_READS_PER_ACTION_BUDGET,
} = {}) {
  ...
  const guiRequestTraffic = summarizeV6GuiRequestTraffic(
    guiDiagnostics,
    actionsPerDevice,
    {
...
export function evaluateV6PersistedOrderTarget({
  handheldDeviceIds,
