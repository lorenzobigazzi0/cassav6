...
export const V5BT_LATENCY_ATTRIBUTION_SCHEMA_VERSION = 1;
...
export function buildV5btLatencyAttribution(runtimeMetrics) {
  ...
  return {
    schemaVersion: V5BT_LATENCY_ATTRIBUTION_SCHEMA_VERSION,
    kind: "v5bt-latency-attribution",
    status: complete ? "COMPLETE" : "INCOMPLETE",
    complete,
    collection,
    categories,
