...
export function parseB5CampaignAuthorization(
  ...
  requireEqual(value.product, "V5BT", "CAMPAIGN_AUTHORIZATION_INVALID", "authorization product is invalid");
...
export function parseB5ReviewAttestation(
  ...
  requireEqual(value.product, "V5BT", "REVIEW_ATTESTATION_INVALID", "review product is invalid");
