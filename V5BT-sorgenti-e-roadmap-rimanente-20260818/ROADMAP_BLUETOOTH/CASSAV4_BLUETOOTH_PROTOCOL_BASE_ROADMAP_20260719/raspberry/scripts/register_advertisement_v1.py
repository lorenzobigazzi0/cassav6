#!/usr/bin/env python3
"""Register one transient CASSAv4 Bluetooth advertisement through BlueZ D-Bus."""
...
ADVERTISEMENT_PATH = "/com/cassav4/bluetooth/lab/advertisement_v1"
SERVICE_UUID = "b1c4a500-7d1f-4f32-9a64-4f4b6c410001"
PROTOCOL_VERSION = 1
LEGACY_FLAGS = 0x06
...
FROZEN_LEGACY_ADVERTISEMENT_HEX = (
    "0201061b210100416c4b4f649a324f1f7d00a5c4b1"
...
def parse_args(argv: list[str]) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Register a transient V5BT v1 BlueZ advertisement. "
