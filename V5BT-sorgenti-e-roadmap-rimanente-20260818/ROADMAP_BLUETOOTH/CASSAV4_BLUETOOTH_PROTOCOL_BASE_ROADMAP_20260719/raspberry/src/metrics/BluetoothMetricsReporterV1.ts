...
export interface BluetoothMetricsReportV1 {
  ...
  readonly source: "V5BT_RASPBERRY_BLUETOOTH_METRICS";
  readonly component: "cassav5bt-bluetooth-node";
  ...
  #sample(): void {
    ...
    try {
      ...
      const report = Object.freeze({
        ...
        source: "V5BT_RASPBERRY_BLUETOOTH_METRICS" as const,
        component: "cassav5bt-bluetooth-node" as const,
