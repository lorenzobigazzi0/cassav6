...
```text
SORGENTE_SISTEMA/cassa-frontend/scripts/run-v5bt-b4-web-gui-lab.mjs
```
...
```bash
node scripts/run-v5bt-b4-web-gui-lab.mjs --dry-run
node --test scripts/run-v5bt-b4-web-gui-lab.test.mjs
node scripts/run-v5bt-b4-web-gui-lab.mjs --start
node scripts/run-v5bt-b4-web-gui-lab.mjs --status
node scripts/run-v5bt-b4-web-gui-lab.mjs --workload
node scripts/run-v5bt-b4-web-gui-lab.mjs --pilot
node scripts/run-v5bt-b4-web-gui-lab.mjs --stop
```
