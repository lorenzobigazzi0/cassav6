# V5BT B2 Android/ADB Physical-Test Harness
...
service, restart the V5BT service or modify the V5BT database.
...
hostname/SAN and leaf SPKI pin must match the isolated V5BT Lab endpoint.
...
redatta dal registry V5BT che l'esatto token sia `CONSUMED` dal nuovo NodeId.
...
scanned, observed at least one valid V5BT advertisement, stayed free of
