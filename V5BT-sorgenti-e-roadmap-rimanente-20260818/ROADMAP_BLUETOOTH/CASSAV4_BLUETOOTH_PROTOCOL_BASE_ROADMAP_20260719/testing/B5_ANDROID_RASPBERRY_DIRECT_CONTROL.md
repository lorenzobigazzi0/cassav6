...
- registry V5BT `0600` leggibile dal solo utente runtime autorizzato;
...
```bash
sudo -u cassav5bt node raspberry/scripts/run-b5-direct-control-smoke.mjs \
  --adapter hci0 \
  --hold-ms 60000 \
  --registry /var/lib/cassav5bt-bluetooth/devices.json \
  --server-node-id <uuid-server-canonico> \
  --boot-id 54 \
  --capabilities 72 \
  --output /tmp/v5bt-b5-7-direct-control.json
```
...
```bash
install -d -m 0700 -o cassav5bt -g cassav5bt \
  /var/lib/cassav5bt-bluetooth/b5-campaign

sudo -u cassav5bt node raspberry/scripts/collect-b5-direct-control-session.mjs \
  --init \
  --state /var/lib/cassav5bt-bluetooth/b5-campaign/campaign.b5-session-gate-state.json

sudo -u cassav5bt node raspberry/scripts/run-b5-campaign-supervisor.mjs \
  --init \
  --ledger /var/lib/cassav5bt-bluetooth/b5-campaign/b5-official-attempts.json \
  --state /var/lib/cassav5bt-bluetooth/b5-campaign/campaign.b5-session-gate-state.json
...
export CASSA_BT_DEVICE_REGISTRY_PATH=/var/lib/cassav5bt-bluetooth/devices.json
...
node raspberry/scripts/collect-b5-direct-control-session.mjs \
  --finalize \
  --state /var/lib/cassav5bt-bluetooth/b5-campaign/campaign.b5-session-gate-state.json \
  --manifest /var/lib/cassav5bt-bluetooth/b5-campaign/b5-hundred-session-manifest.json
```
...
node raspberry/scripts/run-b5-hundred-session-gate.mjs \
  --manifest /var/lib/cassav5bt-bluetooth/b5-campaign/b5-hundred-session-manifest.json \
  --campaign-state /var/lib/cassav5bt-bluetooth/b5-campaign/campaign.b5-session-gate-state.json \
  --attempt-state /var/lib/cassav5bt-bluetooth/b5-campaign/b5-official-attempts.json \
  --android-attestation /var/lib/cassav5bt-bluetooth/b5-campaign/b5-android-attestation.json \
  --raspberry-attestation /var/lib/cassav5bt-bluetooth/b5-campaign/b5-raspberry-attestation.json \
  --campaign-authorization /var/lib/cassav5bt-bluetooth/b5-campaign/b5-campaign-authorization.json \
  --output /var/lib/cassav5bt-bluetooth/b5-campaign/b5-technical-aggregate.json \
  --technical-receipt /var/lib/cassav5bt-bluetooth/b5-campaign/b5-technical-receipt.json
```
...
node raspberry/scripts/run-b5-promotion-gate.mjs \
  --technical-aggregate /var/lib/cassav5bt-bluetooth/b5-campaign/b5-technical-aggregate.json \
  --technical-receipt /var/lib/cassav5bt-bluetooth/b5-campaign/b5-technical-receipt.json \
  --campaign-state /var/lib/cassav5bt-bluetooth/b5-campaign/campaign.b5-session-gate-state.json \
  --campaign-authorization /var/lib/cassav5bt-bluetooth/b5-campaign/b5-campaign-authorization.json \
  --review-attestation /var/lib/cassav5bt-bluetooth/b5-campaign/b5-independent-review.json \
  --output /var/lib/cassav5bt-bluetooth/b5-campaign/b5-promotion.json
```
