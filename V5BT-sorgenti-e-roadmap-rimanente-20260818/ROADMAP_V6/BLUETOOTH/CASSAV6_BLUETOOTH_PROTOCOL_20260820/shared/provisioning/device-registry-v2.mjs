...
const LEGACY_DEVICE_REGISTRY_KIND = "cassav6.bluetooth.device-registry";
...
const TOKEN_PREFIXES = Object.freeze({
  [ENROLLMENT_PROTOCOL_V1]: "c6e1_",
  [ENROLLMENT_PROTOCOL_V2]: "c6e2_"
});
const TOKEN_HASH_CONTEXTS = Object.freeze({
  [ENROLLMENT_PROTOCOL_V1]: "CASSA_V6-BT-ENROLLMENT-TOKEN-V1\0",
  [ENROLLMENT_PROTOCOL_V2]: "CASSA_V6-BT-ENROLLMENT-TOKEN-V2\0"
});
const UUID_PATTERN =
