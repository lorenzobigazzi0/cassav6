...
export function parseStatus(raw) {
  ...
  if (
    ...
    status.source !== "V6_ANDROID_CONNECTIVITY_AGENT" ||
    ...
    throw new B3GateError(
      "STATUS_INVALID",
      "diagnostic status is not an enabled V6 B3 Lab report"
    );
  }
...
export function buildPhysicalSummary(
  ...
  return {
    schemaVersion: 1,
    source: "V6_B3_ANDROID_SERVICE_GATE_HARNESS",
...
export function runSelfTest() {
  ...
  return {
    schemaVersion: 1,
    source: "V6_B3_ANDROID_SERVICE_GATE_HARNESS_SELF_TEST",
    result: "PASS",
    gate: "PENDING",
    physicalRunExecuted: false,
    adbExecuted: false,
