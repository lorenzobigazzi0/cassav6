...
assert.deepEqual(characteristicUuids, [
  "3c9734f1-46cb-5672-96e9-e7a03a710f95",
  "34f16f91-8558-595d-ba61-f0b31b2aa7f0",
  "6c4927da-180d-5e9a-a3c7-c3b7cbccc499",
  "d9af61c0-289d-583d-877c-ef19a49413c9",
  "520f34b8-8e37-50a7-ada0-00252a94f11c",
  "13e8dde6-a0d5-5227-9608-5a71a65de87a",
  "5ea76dec-cbaa-5aee-9156-6058066a3a7a",
  "544e9ea6-c9a9-56f7-a1ed-41afe8c72078"
]);
assert.equal(gattUuids.advertisementServiceData, gattUuids.service);
