...
internal fun resolveConfiguredKioskUrl(savedUrl: String?, defaultUrl: String): String {
    ...
    return if (normalizedUrl in LEGACY_CASSA_V6_SERVER_URLS) defaultUrl else configuredUrl
}

private val LEGACY_CASSA_V6_SERVER_URLS = setOf(
    "https://192.168.1.182:5480/mobile",
    "https://192.168.0.67:5480/mobile"
)
