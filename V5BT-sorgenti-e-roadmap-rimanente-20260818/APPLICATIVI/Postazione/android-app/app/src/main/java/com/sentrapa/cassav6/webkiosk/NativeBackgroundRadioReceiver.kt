...
class NativeBackgroundRadioReceiver(context: Context) {
    ...
    private suspend fun connectAndReceive(config: RadioConfig, session: RadioSession) {
        ...
        val request = Request.Builder()
            .url(buildRadioWsUrl(config.apiBaseUrl))
            .build()
    ...
    private fun buildRadioWsUrl(apiBaseUrl: String): String {
    ...
    private companion object {
        ...
        const val DEFAULT_BACKEND_PORT = 5481
        const val RADIO_CLIENT_APP = "postazione"
