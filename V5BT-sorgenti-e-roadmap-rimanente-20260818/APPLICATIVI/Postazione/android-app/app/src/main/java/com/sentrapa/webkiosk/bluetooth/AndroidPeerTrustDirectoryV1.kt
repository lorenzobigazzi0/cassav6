...
internal const val PEER_TRUST_DIRECTORY_KIND_V1 =
    "cassav5bt.bluetooth.peer-trust-directory"
...
internal fun deriveBluetoothPeerTrustIdV1(
    ...
    val context = "CASSAV5BT-BT-PEER-TRUST-ID-V1\u0000".encodeToByteArray()
...
internal object AndroidPeerTrustDirectoryCodecV1 {
    private const val CONTEXT = "CASSAV5BT-BT-PEER-TRUST-DIRECTORY-V1\u0000"
