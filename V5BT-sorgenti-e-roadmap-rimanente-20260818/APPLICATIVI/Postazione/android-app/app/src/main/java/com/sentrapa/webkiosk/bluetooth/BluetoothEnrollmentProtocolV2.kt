...
object BluetoothEnrollmentProtocolV2 {
    ...
    const val PROOF_CONTEXT = "CASSAV5BT-BT-ENROLLMENT-PROOF-V2"
    ...
    private val tokenPattern =
        Regex("^c5e2_[A-Za-z0-9_-]{42}[AEIMQUYcgkosw048]$")
    ...
    fun isCanonicalToken(value: String): Boolean =
        tokenPattern.matches(value) &&
            runCatching {
                decodeCanonicalBase64Url(value.removePrefix("c5e2_"), 32)
            }.getOrNull() != null
