...
import com.sentrapa.webkiosk.BuildConfig
import com.sentrapa.webkiosk.KioskPreferences
import com.sentrapa.webkiosk.MainActivity
import com.sentrapa.webkiosk.NotificationClientContext
import com.sentrapa.webkiosk.R
...
class BluetoothFailoverService : Service() {
            ...
            platformProfile =
                BluetoothDiscoveryPlatformProfile.fromBuildConfiguration(
                    api31CompatNonGateBuild =
                        BuildConfig.API31_COMPAT_NON_GATE_BUILD,
                    configuredMinimumAndroidApi =
                        BuildConfig.BLUETOOTH_DISCOVERY_MIN_ANDROID_API
                ),
            nodeKind =
    ...
    private fun ensureNotificationChannel() {
        ...
        val channel = NotificationChannel(
            ...
            description = "Mantiene attivo il discovery Bluetooth V5BT."
            setSound(null, null)
    ...
    private fun buildNotification(): Notification {
        ...
        return NotificationCompat.Builder(this, SERVICE_CHANNEL_ID)
            ...
            .setContentTitle("V5BT Bluetooth attivo")
    ...
    companion object {
        ...
        private const val ACTION_START =
            "com.sentrapa.webkiosk.bluetooth.action.START_FAILOVER"
        private const val ACTION_REFRESH =
            "com.sentrapa.webkiosk.bluetooth.action.REFRESH_FAILOVER"
        private const val SERVICE_CHANNEL_ID = "v5bt_bluetooth_failover"
        ...
        fun start(context: Context) {
            val sessionContext =
                KioskPreferences.getNotificationClientContext(context)
            if (
                !shouldStartBluetoothFailoverRuntime(
                    BuildConfig.BLUETOOTH_FAILOVER_ENABLED,
                    sessionContext
                )
            ) return
        ...
        fun stopForSessionClear(context: Context) {
            ...
            runCatching {
                appContext.stopService(
                    Intent(appContext, BluetoothFailoverService::class.java)
                )
            }.onFailure { error ->
                Log.w(
                    TAG,
                    "Arresto servizio Bluetooth al logout non riuscito: ${error.message}"
                )
            }
