...
### RET-01 — Finestre di retention (prima di P11)

Confermare o correggere i valori proposti in
`postgres/060_retention_partitioning.sql`. Vincolo non negoziabile: nessuna
retention su pagamenti, movimenti di cassa e documenti fiscali.

Decidere anche se le tabelle ad alto volume nascono già partizionate: convertirle
dopo, su questo hardware, è molto più costoso.
