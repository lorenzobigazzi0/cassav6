...
export const ANDROID_PEER_AUTH_V2_CONTEXTS = Object.freeze({
  BINDING: "CASSA_V6-BT-ANDROID-A2-BINDING-V2\0",
  CLIENT_SIGNATURE: "CASSA_V6-BT-ANDROID-A2-CLIENT-SIGN-V2\0",
  SERVER_SIGNATURE: "CASSA_V6-BT-ANDROID-A2-SERVER-SIGN-V2\0",
  TRANSCRIPT: "CASSA_V6-BT-ANDROID-A2-TRANSCRIPT-V2\0",
  HKDF: "CASSA_V6-BT-ANDROID-A2-KEYS-V2\0",
  SERVER_CONFIRM: "CASSA_V6-BT-ANDROID-A2-SERVER-CONFIRM-V2\0",
  CLIENT_CONFIRM: "CASSA_V6-BT-ANDROID-A2-CLIENT-CONFIRM-V2\0"
});
