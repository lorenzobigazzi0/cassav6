...
const required=[
  ...
  'raspberry/systemd/cassav6-bluetooth-node.service',
  ...
  'reports/V6_PALMARE_LAB_RECERTIFICATION_20260804.md',
  'reports/V6_B4_MATRIX3_LEDGER_INITIALIZATION_20260805.md',
  'reports/V6_B4_TWO_PHYSICAL_EIGHT_SIMULATED_NON_GATE_20260806.md',
  'reports/V6_TWO_ANDROID_PHYSICAL_RESUME_20260803.md',
  'reports/V6_B11_MAXIMUM_VIRTUALIZED_SYSTEM_NON_GATE_20260818.json',
  'reports/V6_B11_MAXIMUM_VIRTUALIZED_SYSTEM_NON_GATE_20260818.md',
  'reports/V6_B11_MAXIMUM_MIXED_PHYSICAL_VIRTUAL_NON_GATE_20260818.json',
  'reports/V6_B11_MAXIMUM_MIXED_PHYSICAL_VIRTUAL_NON_GATE_20260818.md',
  'reports/physical/V6_B11_MIXED_PHYSICAL_ATTESTATION_REDACTED_20260818.json',
  'reports/physical/v6-b0-two-handheld-supplemental-20260803.json',
  'reports/physical/v6-b0-two-handheld-supplemental-20260804.json',
  'reports/physical/v6-b2-two-handheld-non-gate-20260803.json',
  'reports/physical/v6-b2-two-handheld-non-gate-20260803-retry1.json',
  'reports/physical/v6-b2-two-handheld-non-gate-20260803-retry2.json',
  'reports/physical/v6-b2-two-handheld-non-gate-20260804-retry3.json',
  'reports/physical/v6-b4-3-servicedata-gate-20260720.json',
  'reports/physical/v6-b4-4-collection-progress-20260720.json',
  'reports/physical/v6-b5-3-gatt-smoke-20260720.json',
  'reports/physical/v6-b5-4-android-gatt-client-20260720.json',
  'reports/physical/v6-b5-5-android-hello-20260720.json',
  'reports/physical/v6-b5-5-raspberry-hello-20260720.json',
  'reports/physical/v6-raspberry-continuity-supplemental-20260804.json',
  'reports/physical/v6-two-handheld-final-inventory-redacted-20260804.json',
  'reports/V6_ANDROID_ENROLLMENT_DISCOVERY_BUILD_20260720.md',
...
const workspaceRequired=[
  ...
  'scripts/run-v6-bench-inventory.mjs',
  'scripts/run-v6-b4-android-continuity-monitor.mjs',
  'scripts/run-v6-b4-raspberry-continuity-monitor.mjs',
  'scripts/run-v6-physical-raspberry-monitor.mjs',
  'scripts/verify-v6-advanced-build-consistency.mjs',
  'tests/run-b11-mixed-physical-collector.test.mjs',
  'tests/run-v6-bench-inventory.test.mjs',
  'tests/run-v6-b4-android-continuity-monitor.test.mjs',
  'tests/run-v6-b4-raspberry-continuity-monitor.test.mjs',
  'tests/run-v6-physical-raspberry-monitor.test.mjs',
  'tests/verify-v6-advanced-build-consistency.test.mjs'
];
const missing=[
...
const enrollmentEnvironmentExamplePath=path.join(root,'configs/cassav6-bluetooth-enrollment.env.example');
const enrollmentUnitPath=path.join(root,'raspberry/systemd/cassav6-bluetooth-enrollment.service');
const bluezNodeUnitPath=path.join(root,'raspberry/systemd/cassav6-bluetooth-node.service');
const raspberryPackagePath=path.join(root,'raspberry/package.json');
const b4PhysicalReportPath=path.join(root,'reports/physical/v6-b4-3-servicedata-gate-20260720.json');
const b4PhysicalLogPath=path.join(root,'reports/physical/v6-b4-3-servicedata-node-20260720.log');
const b4CollectionProgressPath=path.join(root,'reports/physical/v6-b4-4-collection-progress-20260720.json');
const b5GattPhysicalReportPath=path.join(root,'reports/physical/v6-b5-3-gatt-smoke-20260720.json');
const b5AndroidGattPhysicalReportPath=path.join(root,'reports/physical/v6-b5-4-android-gatt-client-20260720.json');
const b55AndroidHelloReportPath=path.join(root,'reports/physical/v6-b5-5-android-hello-20260720.json');
const b55RaspberryHelloReportPath=path.join(root,'reports/physical/v6-b5-5-raspberry-hello-20260720.json');
...
const b11MaximumVirtualizedReportPath=path.join(root,'reports/V6_B11_MAXIMUM_VIRTUALIZED_SYSTEM_NON_GATE_20260818.json');
...
const b11MixedPhysicalAttestationPath=path.join(root,'reports/physical/V6_B11_MIXED_PHYSICAL_ATTESTATION_REDACTED_20260818.json');
...
const b11MixedPhysicalVirtualReportPath=path.join(root,'reports/V6_B11_MAXIMUM_MIXED_PHYSICAL_VIRTUAL_NON_GATE_20260818.json');
const b4AuthoritativeGatePath=path.join(root,'raspberry/scripts/run-b4-ten-device-gate.mjs');
const b4AndroidMonitorPath=path.join(workspaceRoot,'scripts/run-v6-b4-android-continuity-monitor.mjs');
const b4RaspberryMonitorPath=path.join(workspaceRoot,'scripts/run-v6-b4-raspberry-continuity-monitor.mjs');
...
const benchInventoryPath=path.join(workspaceRoot,'scripts/run-v6-bench-inventory.mjs');
const buildConsistencyPath=path.join(workspaceRoot,'scripts/verify-v6-advanced-build-consistency.mjs');
...
for(const physicalGatePath of [b4AuthoritativeGatePath,b5HundredSessionGatePath,b5PromotionGatePath]){
  ...
  for(const forbiddenReference of [
    'MAXIMUM_VIRTUALIZED_SYSTEM_NON_GATE',
    'V6_B11_MAXIMUM_VIRTUALIZED_SYSTEM',
    'MAXIMUM_MIXED_PHYSICAL_VIRTUAL_SYSTEM_NON_GATE',
    'V6_B11_MAXIMUM_MIXED_PHYSICAL_VIRTUAL',
    '--virtualized-report'
  ]){
...
if(fs.existsSync(b5AccountDeviceCommitmentPath)){
  ...
  for(const requiredControl of [
    'V6:B5:ACCOUNT_DEVICE_COMMITMENT:1',
...
if(fs.existsSync(b5TechnicalReceiptSchemaPath)){
  try{
    ...
    if(
      ...
      schema.properties?.product?.const!=='V6'||
...
if(fs.existsSync(benchInventoryPath)){
  ...
  for(const requiredControl of [
    ...
    if(!inventory.includes(requiredControl)){
      isolationErrors.push(`V6 bench inventory is missing read-only control: ${requiredControl}`);
    }
  }
}
if(fs.existsSync(buildConsistencyPath)){
  ...
  for(const requiredControl of [
    ...
    if(!verifier.includes(requiredControl)){
      isolationErrors.push(`V6 Advanced build consistency verifier is missing control: ${requiredControl}`);
    }
  }
}
...
if(fs.existsSync(b55AndroidHelloReportPath)){
  try{
    ...
    if(
      report.schemaVersion!==2||
      report.source!=='V6_ANDROID_GATT_HELLO_LAB'||
...
if(fs.existsSync(raspberryEnvironmentPath)){
  ...
  if(environment.CASSA_BT_STATE_ROOT!=='/var/lib/cassav6-bluetooth'){
    isolationErrors.push('CASSA_BT_STATE_ROOT must use the V6 state directory');
  }
  if(environment.CASSA_BT_DEVICE_REGISTRY_PATH!=='/var/lib/cassav6-bluetooth/devices.json'){
    isolationErrors.push('CASSA_BT_DEVICE_REGISTRY_PATH must use the V6 registry');
  }
}
if(fs.existsSync(enrollmentEnvironmentExamplePath)){
  ...
  const expectedEnvironment={
    ...
    CASSA_BT_ENROLLMENT_ENDPOINT_ID:'raspberry-lab-cassav6',
    CASSA_BT_ENROLLMENT_TLS_CERT:'/etc/cassav6/bluetooth-enrollment.crt',
    CASSA_BT_ENROLLMENT_TLS_KEY:'/etc/cassav6/bluetooth-enrollment.key',
    CASSA_BT_STATE_ROOT:'/var/lib/cassav6-bluetooth',
    CASSA_BT_DEVICE_REGISTRY:'/var/lib/cassav6-bluetooth/devices.json'
  };
  ...
  if(/cassav(?:4|5bt)/i.test(text)){
    isolationErrors.push('V6 enrollment EnvironmentFile must not reference legacy product state');
  }
}
if(fs.existsSync(enrollmentUnitPath)){
  const enrollmentUnit=fs.readFileSync(enrollmentUnitPath,'utf8');
  if(/cassav(?:4|5bt)/i.test(enrollmentUnit)){
    isolationErrors.push('V6 enrollment unit must not reference legacy product state');
  }
  if(!enrollmentUnit.includes('EnvironmentFile=-/etc/cassav6/cassav6-bluetooth-enrollment.env')){
    isolationErrors.push('V6 enrollment unit must use its isolated EnvironmentFile');
  }
  if(!enrollmentUnit.includes('StateDirectory=cassav6-bluetooth')){
    isolationErrors.push('V6 enrollment unit must create its isolated state directory');
  }
  if(!enrollmentUnit.includes('StateDirectoryMode=0700')){
    isolationErrors.push('V6 enrollment unit must keep its state directory private');
  }
  if(!enrollmentUnit.includes('ReadWritePaths=/var/lib/cassav6-bluetooth')){
    isolationErrors.push('V6 enrollment unit must use its isolated writable state directory');
  }
}
if(fs.existsSync(bluezNodeUnitPath)){
  const bluezNodeUnit=fs.readFileSync(bluezNodeUnitPath,'utf8');
  if(/cassav(?:4|5bt)/i.test(bluezNodeUnit)){
    isolationErrors.push('V6 BlueZ node unit must not reference legacy product state');
  }
  if(!bluezNodeUnit.includes('User=cassav6')){
    isolationErrors.push('V6 BlueZ node unit must use the isolated service user');
  }
  if(!bluezNodeUnit.includes('WorkingDirectory=/opt/cassav6-bluetooth-node/raspberry')){
    isolationErrors.push('V6 BlueZ node unit must use the isolated working directory');
  }
  if(!bluezNodeUnit.includes('Environment=CASSA_BT_FEATURE_ENABLED=0')){
    isolationErrors.push('V6 BlueZ node unit must keep the feature disabled by default');
  }
  if(!bluezNodeUnit.includes('Environment=CASSA_BT_GATT_SERVER_ENABLED=0')){
    isolationErrors.push('V6 BlueZ node unit must keep the GATT server disabled by default');
  }
  if(!bluezNodeUnit.includes('Environment=CASSA_BT_HELLO_ENABLED=0')){
    isolationErrors.push('V6 BlueZ node unit must keep HELLO disabled by default');
  }
  if(!bluezNodeUnit.includes('Environment=CASSA_BT_DRY_RUN=1')){
    isolationErrors.push('V6 BlueZ node unit must keep dry-run enabled by default');
  }
  if(!bluezNodeUnit.includes('EnvironmentFile=-/etc/cassav6/cassav6-bluetooth-node.env')){
    isolationErrors.push('V6 BlueZ node unit must use its isolated EnvironmentFile');
  }
}
if(fs.existsSync(raspberryPackagePath)){
  ...
  if(raspberryPackage.dependencies?.['@jellybrick/dbus-next']!=='0.11.1'){
    isolationErrors.push('V6 BlueZ node must pin @jellybrick/dbus-next to 0.11.1');
  }
  if(Object.hasOwn(raspberryPackage.dependencies??{},'dbus-next')){
    isolationErrors.push('V6 BlueZ node must not depend on the obsolete unscoped dbus-next package');
  }
  if(raspberryPackage.scripts?.['gate:b4-servicedata']!=='node scripts/run-b4-raspberry-servicedata-gate.mjs'){
    isolationErrors.push('V6 B4 ServiceData gate script is missing or has changed');
  }
  if(raspberryPackage.scripts?.['gate:b4-ten-device']!=='node scripts/run-b4-ten-device-gate.mjs'){
    isolationErrors.push('V6 B4 ten-device gate script is missing or has changed');
  }
  if(raspberryPackage.scripts?.['gate:b5-gatt-smoke']!=='npm run build && node scripts/run-b5-raspberry-gatt-smoke.mjs'){
    isolationErrors.push('V6 B5.3 physical GATT smoke script is missing or has changed');
  }
  if(raspberryPackage.scripts?.['gate:b5-hello-smoke']!=='npm run build && node scripts/run-b5-android-hello-smoke.mjs'){
    isolationErrors.push('V6 B5.5 physical HELLO smoke script is missing or has changed');
  }
  if(raspberryPackage.scripts?.['supervise:b5-campaign']!=='node scripts/run-b5-campaign-supervisor.mjs'){
    isolationErrors.push('V6 B5 campaign supervisor script is missing or has changed');
  }
  if(raspberryPackage.scripts?.['monitor:b5-raspberry']!=='node ../scripts/run-b5-raspberry-continuity-monitor.mjs'){
    isolationErrors.push('V6 B5 Raspberry continuity monitor script is missing or has changed');
  }
  if(raspberryPackage.scripts?.['gate:b5-hundred-session']!=='node scripts/run-b5-hundred-session-gate.mjs'){
    isolationErrors.push('V6 B5 technical hundred-session gate script is missing or has changed');
  }
  if(raspberryPackage.scripts?.['gate:b5-promote']!=='node scripts/run-b5-promotion-gate.mjs'){
    isolationErrors.push('V6 B5 independent-review promotion script is missing or has changed');
  }
}
