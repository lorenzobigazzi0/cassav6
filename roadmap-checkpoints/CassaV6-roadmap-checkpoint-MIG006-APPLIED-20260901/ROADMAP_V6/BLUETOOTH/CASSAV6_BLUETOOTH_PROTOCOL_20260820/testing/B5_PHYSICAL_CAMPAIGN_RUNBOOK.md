...
Il servizio `cassav6.service` non deve essere fermato, riavviato, ricaricato
...
```bash
node scripts/run-v6-bench-inventory.mjs \
...
Il monitor Raspberry controlla in continuita `cassav6.service` e
