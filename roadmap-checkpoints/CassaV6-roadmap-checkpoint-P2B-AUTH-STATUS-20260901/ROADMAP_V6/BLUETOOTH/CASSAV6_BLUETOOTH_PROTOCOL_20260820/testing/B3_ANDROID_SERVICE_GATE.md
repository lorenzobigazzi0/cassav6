# V6 B3 Android Foreground-Service Gate

`scripts/run-b3-android-service-gate.mjs` measures the native V6 Android
...
open a GATT session, contact Raspberry, restart V6 or modify its database. It
...
node scripts/run-b3-android-service-gate.mjs \
  --handheld-serial RFGYA0ZAGFW \
  --station-serial R9WT50ZN5VZ \
  --output reports/physical/v6-b3-android-service.json
```
