...
function config(overrides = {}) {
  return Object.freeze({
    ...
    deviceRegistryPath: "/var/lib/cassav6-bluetooth/devices.json",
    transportStorePath: "/var/lib/cassav6-bluetooth/transport.sqlite",
...
test("configuration is disabled and dry-run by default", () => {
  ...
  assert.equal(
    ...
    "/var/lib/cassav6-bluetooth/transport.sqlite"
  );
...
test("configuration rejects ambiguous flags and unsafe adapter names", () => {
  ...
  const mutualAuth = loadBluezNodeConfig({
    ...
    CASSA_BT_NODE_ID: "123e4567-e89b-12d3-a456-426614174000",
    CASSA_BT_DEVICE_REGISTRY_PATH: "/srv/cassav6/devices.json"
  });
  ...
  const reliable = loadBluezNodeConfig({
    ...
    CASSA_BT_NODE_ID: "123e4567-e89b-12d3-a456-426614174000",
    CASSA_BT_TRANSPORT_STORE_PATH: "/srv/cassav6/transport.sqlite",
  ...
  assert.equal(reliable.transportStorePath, "/srv/cassav6/transport.sqlite");
