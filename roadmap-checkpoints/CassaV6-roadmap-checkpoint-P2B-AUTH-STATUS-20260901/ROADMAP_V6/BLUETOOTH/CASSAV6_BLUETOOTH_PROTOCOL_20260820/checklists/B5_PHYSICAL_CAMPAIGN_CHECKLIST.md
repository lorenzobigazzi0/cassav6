...
- [ ] `verify-v6-advanced-build-consistency.mjs` restituisce `ok: true`.
...
- [ ] Postazione Lab artefatto
      `artifacts/Postazione-Advanced-v2.0.23-V6-B0-B2-Cooldown-Lab-20260805-debug.apk`,
      SHA-256
...
- [ ] Il servizio `cassav6.service` non viene fermato, riavviato, ricaricato
...
- [ ] La baseline Raspberry vincola boot ID e snapshot di
      `cassav6.service` e `bluetooth.service`.
