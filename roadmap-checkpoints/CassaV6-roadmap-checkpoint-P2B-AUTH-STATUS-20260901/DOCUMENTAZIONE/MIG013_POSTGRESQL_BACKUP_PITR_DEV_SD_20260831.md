...
> Nota 2026-09-01: i tempi riportati sotto sono misure del dataset vuoto
> `temporary_mig013_probe` (`production_certified=false`). Non rappresentano
> una stima della finestra di manutenzione P12/P14 e non devono essere usati
> come previsione di restore del dataset reale.
