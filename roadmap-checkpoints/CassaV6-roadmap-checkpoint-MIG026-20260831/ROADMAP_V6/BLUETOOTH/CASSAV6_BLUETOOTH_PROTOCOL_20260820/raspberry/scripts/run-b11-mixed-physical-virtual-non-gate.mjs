...
const SERVICE_POLICIES = Object.freeze({
  ...
  "cassav6-bluetooth-node.service": Object.freeze({
    requirement: "OBSERVE_ONLY",
    expectedState: "ANY_OBSERVED_STATE"
  }),
  "cassav6-bluetooth-enrollment.service": Object.freeze({
    requirement: "OBSERVE_ONLY",
    expectedState: "ANY_OBSERVED_STATE"
  })
});
