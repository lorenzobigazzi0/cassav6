...
Prima dell'attivazione servono due conferme:

1. finestre proposte accettate o corrette;
2. strategia di partizionamento dei futuri eventi e soluzione esplicita per
   l'unicita globale delle chiavi delle tre tabelle foundation gia create.
