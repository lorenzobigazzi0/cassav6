...
const INPUT_SOURCE = "V6_API31_COMPAT_PRIVATE_CAPTURE";
const REPORT_SOURCE = "V6_API31_COMPAT_NON_GATE_REPORT";
...
export function parseApi31CompatCapture(raw) {
  ...
  exactValue(value.product, "V6", "capture.product");
  exactKeys(
    value.profile,
    [
      "applicationId",
...
export function parseApi31CompatPhysicalCapture(raw) {
  ...
  exactValue(value.product, "V6", "physical.product");
...
function usage() {
  return [
    "V6 API 31 compatibility diagnostic (prephysical or physical, non-gate only)",
    "",
    "Usage:",
