...
export const IDENTITY_BOUNDARIES = Object.freeze([
  {
    ...
    directReadDbExpected: 1,
    directWriteDbExpected: 3,
  },
  {
    method: "POST",
...
export function analyzeIdentityPilotSources({ routeRegistrySource, handlerSources, serverSource }) {
  ...
  return {
    ...
    status: "P2B_IDENTITY_INVENTORIED_P2B2_ALREADY_EXTRACTED_P2B3_P2B4_OPEN",
    ...
    nextGate: "P2b.3/P2b.4 identity: zero readDb/writeDb diretti negli handler identity",
  };
}
